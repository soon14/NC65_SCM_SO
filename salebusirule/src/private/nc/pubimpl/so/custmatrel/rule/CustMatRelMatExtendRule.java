 ...
 * @author 祝会征
 */
public class CustMatRelMatExtendRule {
   ...
   * @return
   */
  public List<CustMatRelParaVO> extendBaseClass(CustMatRelParaVO[] matchparas) {
    List<CustMatRelParaVO> paraList = new ArrayList<CustMatRelParaVO>();
    Set<String> pkSet = new HashSet<String>();
    for (CustMatRelParaVO para : matchparas) {
      paraList.add(para);
   ...
   * @return
   */
  public List<CustMatRelParaVO> extendMarSaleClass(CustMatRelParaVO[] matchparas) {
    List<CustMatRelParaVO> paraList = new ArrayList<CustMatRelParaVO>();
    Set<String> pkSet = new HashSet<String>();
    for (CustMatRelParaVO para : matchparas) {
      paraList.add(para);
