 ...
 */
public class RewriteOPCWhenOutClose implements IRule<SaleOrderViewVO> {
  ...
  public void process(SaleOrderViewVO[] vos) {
    ...
    try {
      ...
      rewrite.closeOut(listParas.toArray(new DocIDPara[listParas.size()]));
    }
    catch (Exception e) {
