...
/**
 * @description
 * 信用占用提供给销售订单的整单动作后的信用检查
 * @scene
 * 销售订单审批、取消审批、新增、修改保存后
 * @param 
 * billaction 销售管理动作Action
 */
public class RenovateARByHidsEndRule implements IRule<SaleOrderVO> {

  private M30EngrossAction billaction;

  public RenovateARByHidsEndRule(M30EngrossAction billaction) {
