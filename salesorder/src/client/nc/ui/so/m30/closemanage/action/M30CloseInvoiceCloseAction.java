...
public class M30CloseInvoiceCloseAction extends NCAction implements
    IMultiReturnObjProcessor, ProgressActionInterface {

  /**
   * 
   */
  private static final long serialVersionUID = 1976924013552959687L;
  ...
  public M30CloseInvoiceCloseAction() {
    ...
    if (this.getSingleBillService() != null) {
      if (bills.length > 1) {
        ...
        this.getMultiBillTaskRunner()
            .setTitle(
                NCLangRes.getInstance()
                    .getStrByID("4006011_0", "04006011-0287")/*发票关闭*/);
  ...
  protected boolean isActionEnable() {
    ...
    UFBoolean binvoicendflag = vo.getBody().getBbinvoicendflag();
    if (binvoicendflag.booleanValue()) {
      return false;
    }
