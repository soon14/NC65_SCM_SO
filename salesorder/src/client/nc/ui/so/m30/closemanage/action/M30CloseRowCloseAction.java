...
public class M30CloseRowCloseAction extends NCAction implements
    IMultiReturnObjProcessor, ProgressActionInterface {

  private static final long serialVersionUID = -6452776094770061426L;
    ...
    if (this.getSingleBillService() != null) {
      if (bills.length > 1) {
        ...
        this.getMultiBillTaskRunner()
            .setTitle(
                NCLangRes.getInstance()
                    .getStrByID("4006011_0", "04006011-0290")/*行关闭*/);
  ...
  public void processReturnObjs(Object[] returnObj) {
    ...
    this.getRefreshAction().getDataManager().refresh();
  }
