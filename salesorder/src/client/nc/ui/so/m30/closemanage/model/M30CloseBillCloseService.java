...
public class M30CloseBillCloseService implements
    ISingleBillService<SaleOrderVO> {

  @Override
  public SaleOrderVO operateBill(SaleOrderVO bill) throws Exception {
    ...
    ret = service.closeSaleOrder(new SaleOrderVO[] {
        bill
      });
    // 此返回的值有缺陷，不能完全正确的将变化view更新至前台，需要刷新界面
    return null == ret ? null : this.filterReturnbvo(bill,ret[0]);
  }
