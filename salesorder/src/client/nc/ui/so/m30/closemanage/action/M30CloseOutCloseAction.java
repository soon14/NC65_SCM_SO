...
public class M30CloseOutCloseAction extends NCAction implements
    IMultiReturnObjProcessor, ProgressActionInterface {

  /**
   * 
   */
  private static final long serialVersionUID = -5808714055995324110L;
    ...
    if (this.getSingleBillService() != null) {
      if (bills.length > 1) {
        ...
        this.getMultiBillTaskRunner()
            .setTitle(
                NCLangRes.getInstance()
                    .getStrByID("4006011_0", "04006011-0288")/*出库关闭*/);
  ...
  protected boolean isActionEnable() {
    ...
    UFBoolean boutendflag = vo.getBody().getBboutendflag();
    if (boutendflag.booleanValue()) {
      return false;
    }
