...
public class M30CloseInvoiceOpenAction extends NCAction implements
    IMultiReturnObjProcessor, ProgressActionInterface {

  /**
   * 
   */
  private static final long serialVersionUID = 779488181910323382L;
  ...
  public M30CloseInvoiceOpenAction() {
    ...
    if (this.getSingleBillService() != null) {
      if (bills.length > 1) {
        ...
        this.getMultiBillTaskRunner()
            .setTitle(
                NCLangRes.getInstance()
                    .getStrByID("4006011_0", "04006011-0378")/*发票打开*/);
