...
public class M30CloseSettleOpenAction extends NCAction implements
    IMultiReturnObjProcessor, ProgressActionInterface {

  private static final long serialVersionUID = 1666821441144320058L;
  ...
  public M30CloseSettleOpenAction() {
    SCMActionInitializer.initializeAction(this, SCMActionCode.SO_SETTLEOPEN);
  }
    ...
    if (this.getSingleBillService() != null) {
      if (bills.length > 1) {
        ...
        this.getMultiBillTaskRunner()
            .setTitle(
                NCLangRes.getInstance()
                    .getStrByID("4006011_0", "04006011-0386")/*结算打开*/);
