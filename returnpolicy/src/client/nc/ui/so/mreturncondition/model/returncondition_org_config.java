...
public class returncondition_org_config extends AbstractJavaBeanDefinition{
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getVSNode_1079439());
...
public nc.ui.uif2.tangramlayout.node.VSNode getVSNode_1079439(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#1079439")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#1079439");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#1079439",bean);
  bean.setDown(getCNode_1b2a0e0());
  bean.setUp(getCNode_5fe262());
  bean.setDividerLocation(31f);
return bean;
}

public nc.ui.uif2.tangramlayout.node.CNode getCNode_1b2a0e0(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1b2a0e0")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1b2a0e0");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1b2a0e0",bean);
  bean.setComponent(getList());
return bean;
}

public nc.ui.uif2.tangramlayout.node.CNode getCNode_5fe262(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#5fe262")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#5fe262");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#5fe262",bean);
  bean.setComponent(getOrgPanel());
return bean;
}

public List getManagedList1(){  List list = new ArrayList();  list.add(getAddAction());  list.add(getEditAction());  list.add(getDelAction());  list.add(getSeparatorAction_9452b7());  list.add(getRefreshAction());  list.add(getSeparatorAction_1c2ab40());  list.add(getMaintainActionGroup());  return list;}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_9452b7(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#9452b7")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#9452b7");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#9452b7",bean);
return bean;
}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_1c2ab40(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#1c2ab40")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#1c2ab40");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#1c2ab40",bean);
return bean;
}

public List getManagedList2(){  List list = new ArrayList();  list.add(getSaveAction());  list.add(getSeparatorAction_179070a());  list.add(getCancelAction());  return list;}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_179070a(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#179070a")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#179070a");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#179070a",bean);
return bean;
}
