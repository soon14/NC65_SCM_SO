...
/**
 * ?user> 功能：源销售发票日期 日期：(2004-6-30 11:09:57)
 */
public class SaleInvoiceBillDatePane extends UIDialog implements IRefReturn {
  class IvjEventHandler implements java.awt.event.ActionListener {
    @Override
    public void actionPerformed(java.awt.event.ActionEvent e) {
      if (e.getSource() == SaleInvoiceBillDatePane.this.getBtnCancel()) {
        SaleInvoiceBillDatePane.this.connEtoC1();
      }
      if (e.getSource() == SaleInvoiceBillDatePane.this.getBtnOk()) {
        SaleInvoiceBillDatePane.this.connEtoC2();
      }
    }
  }
  ...
  public SaleInvoiceBillDatePane() {
    super();
    this.initialize();
  }
  ...
  void onOk() {
    ...
    String sName = "getSaleInvoiceBillDate()";
    String sOperate = this.getUIOperate().getSelectedItem().toString();
    String sValue = this.getUIValue().getText().trim();
    String sValueCode = "";

    if ((sValue == null) || (sValue.length() == 0)) {
      MessageDialog.showErrorDlg(this, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("4006006_0","04006006-0014")/*@res "警告"*/, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("4006006_0","04006006-0022")/*@res "请输入函数值!"*/);
      return;
    }
    if (sValue.length() == 10) {
      sValueCode =
      ...
      MessageDialog.showErrorDlg(this, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("4006006_0","04006006-0014")/*@res "警告"*/, nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("4006006_0","04006006-0023")/*@res "输入日期的格式不正确!"*/);
      return;
    }

    this.m_sReturnCode = sLogic + sName + sOperate + "\"" + sValueCode + "\"";
    this.m_sReturnName = NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0103", null, new String[]{sLogic,sOperate,sValue})/*{0}源销售发票日期(){1}"{2}"*/;
    this.closeOK();
  }
  ...
  private UILabel getUIName() {
    if (this.m_lblName == null) {
      ...
      this.m_lblName.setText(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0104")/*源销售发票日期:*/);
