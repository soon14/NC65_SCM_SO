...
public class FormulaRefView extends UIPanel {
  ...
  private UIButton accessibleContextivjUIBnBusiClear;
  ...
  public String trimSubString(String sWhole, String sSub) {
    String str = null;
    while (sWhole.indexOf(sSub) >= 0) {
      str =
          sWhole.substring(0, sWhole.indexOf(sSub))
              + sWhole.substring(sWhole.indexOf(sSub) + sSub.length(),
                  sWhole.length());
    }
    return str;
  }
  ...
  UIButton getUIBnBusiClear() {
    if (this.accessibleContextivjUIBnBusiClear == null) {
      this.accessibleContextivjUIBnBusiClear = new nc.ui.pub.beans.UIButton();
      this.accessibleContextivjUIBnBusiClear.setName("UIBnBusiClear");
      this.accessibleContextivjUIBnBusiClear.setText(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0070")/*清空*/);
      this.accessibleContextivjUIBnBusiClear
          .setMaximumSize(new java.awt.Dimension(50, 22));
      this.accessibleContextivjUIBnBusiClear
          .setPreferredSize(new java.awt.Dimension(50, 22));
      this.accessibleContextivjUIBnBusiClear.setMargin(new java.awt.Insets(2,
          0, 2, 0));
      this.accessibleContextivjUIBnBusiClear.setBounds(55, 1, 50, 22);
      this.accessibleContextivjUIBnBusiClear
          .setMinimumSize(new java.awt.Dimension(50, 22));
    }
    return this.accessibleContextivjUIBnBusiClear;
  }
  ...
  UIButton getUIBnBusiDel() {
    if (this.ivjUIBnBusiDel == null) {
      ...
      this.ivjUIBnBusiDel.setText(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0071")/*删除*/);
  ...
  UIButton getUIBnBusiUndo() {
    if (this.ivjUIBnBusiUndo == null) {
      ...
      this.ivjUIBnBusiUndo.setText(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0072")/*撤销*/);
  ...
  UIButton getUIBnFormulaCheck() {
    if (this.ivjUIBnFormulaCheck == null) {
      ...
      this.ivjUIBnFormulaCheck.setText(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0073")/*公式检查*/);
  ...
  UILabel getUILabFuncSm() {
    if (this.ivjUILabFuncSm == null) {
      ...
      this.ivjUILabFuncSm.setText(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0074")/*函数说明*/);
  ...
  UILabel getUILabGsEdit() {
    if (this.ivjUILabGsEdit == null) {
      ...
      this.ivjUILabGsEdit.setText(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0075")/*公式编辑:*/);
  ...
  UILabel getUILabYwFunc() {
    if (this.ivjUILabYwFunc == null) {
      ...
      this.ivjUILabYwFunc.setText(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0076")/*业务函数:*/);
  ...
  private void onFormulaCheck() {
    ...
    try {
      if ((sFormula != null) && !"".equals(sFormula.trim())
          && (sFormula.length() > 0)) {
        nc.ui.bank_cvp.formulainterface.RefCompilerClient.check(sFormula);
        MessageDialog.showHintDlg(this, NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0019")/*提示*/, NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0020")/*公式检查成功*/);
      }
    }
    catch (Exception e) {
      ExceptionUtils.wrappBusinessException(e.getMessage());
