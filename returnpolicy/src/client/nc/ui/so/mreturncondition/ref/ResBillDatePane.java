 ...
 */
public class ResBillDatePane extends UIDialog implements IRefReturn {

  class IvjEventHandler implements java.awt.event.ActionListener {

    @Override
    public void actionPerformed(java.awt.event.ActionEvent e) {
      if (e.getSource() == ResBillDatePane.this.getBtnCancel()) {
        ResBillDatePane.this.connEtoC1();
      }
      if (e.getSource() == ResBillDatePane.this.getBtnOk()) {
        ResBillDatePane.this.connEtoC2();
      }
    }
  }
    ...
    if (sValue == null || sValue.length() == 0) {
      MessageDialog.showErrorDlg(
          ...
          nc.ui.ml.NCLangRes.getInstance().getStrByID("4006006_0",
              "04006006-0014")/* @res "警告" */,
          nc.ui.ml.NCLangRes.getInstance().getStrByID("4006006_0",
              "04006006-0022")/* @res "请输入函数值!" */);
      return;
    }
    if (sValue.length() == 10) {
      sValueCode =
      ...
      MessageDialog.showErrorDlg(
          ...
          nc.ui.ml.NCLangRes.getInstance().getStrByID("4006006_0",
              "04006006-0139")/* @res "输入日期的格式不正确" */);
      return;
    }
    this.m_sReturnCode = sLogic + sName + sOperate + "\"" + sValueCode + "\"";
    this.m_sReturnName =
        NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0095", null,
            new String[] {
