...
/**
 * ?user> 功能：源销售订单日期 日期：(2004-6-30 11:09:57)
 */
public class SaleOrderBillDatePane extends UIDialog implements IRefReturn {
  class IvjEventHandler implements java.awt.event.ActionListener {
    @Override
    public void actionPerformed(java.awt.event.ActionEvent e) {
      if (e.getSource() == SaleOrderBillDatePane.this.getBtnCancel()) {
        SaleOrderBillDatePane.this.connEtoC1();
      }
      if (e.getSource() == SaleOrderBillDatePane.this.getBtnOk()) {
        SaleOrderBillDatePane.this.connEtoC2();
      }
    }
  }
  ...
  void onOk() {
    ...
    String sName = "getSaleOrderBillDate()";
    ...
    this.m_sReturnName = NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0105", null, new String[]{sLogic,sOperate,sValue})/*{0}源销售订单日期(){1}"{2}"*/;
    this.closeOK();
  }
  ...
  private UILabel getUIName() {
    if (this.m_lblName == null) {
      ...
      this.m_lblName.setText(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0106")/*源销售订单日期:*/);
