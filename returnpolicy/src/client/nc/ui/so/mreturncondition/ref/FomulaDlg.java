 ...
 * @author：左小军
 */
public class FomulaDlg extends nc.ui.pub.beans.UIDialog {
  class IvjEventHandler implements java.awt.event.ActionListener {
    @Override
    public void actionPerformed(java.awt.event.ActionEvent e) {
      if (e.getSource() == FomulaDlg.this.getBtnCancel()) {
        FomulaDlg.this.connEtoC1();
      }
      if (e.getSource() == FomulaDlg.this.getBtnOk()) {
        FomulaDlg.this.connEtoC2();
      }
    }
  }
  ...
  private FormulaView m_fvFormula;
   ...
   *          java.awt.Container
   */
  public FomulaDlg(java.awt.Container parent) {
    super(parent);
    this.initialize();
  }
   ...
   *          java.lang.String
   */
  public FomulaDlg(java.awt.Container parent, String title) {
    super(parent, title);
  }
   ...
   *          java.awt.Frame
   */
  public FomulaDlg(java.awt.Frame owner) {
    super(owner);
  }
   ...
   *          java.lang.String
   */
  public FomulaDlg(java.awt.Frame owner, String title) {
    super(owner, title);
  }
  ...
  private FormulaView getFormulaView() {
    if (this.m_fvFormula == null) {
      this.m_fvFormula = new FormulaView();
      this.m_fvFormula.setName("FormulaEdit");
      this.m_fvFormula.setBounds(10, 10, 639, 425);
    }
