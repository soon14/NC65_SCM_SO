 ...
 */
public class InvLifePrdPane extends UIDialog implements IRefReturn {
  class IvjEventHandler implements java.awt.event.ActionListener {
    @Override
    public void actionPerformed(java.awt.event.ActionEvent e) {
      if (e.getSource() == InvLifePrdPane.this.getBtnCancel()) {
        InvLifePrdPane.this.connEtoC1();
      }
      if (e.getSource() == InvLifePrdPane.this.getBtnOk()) {
        InvLifePrdPane.this.connEtoC2();
      }
    }
  }
  ...
  void onOk() {
    ...
    String sName = "getInvLifePrd()";
    String sOperate = this.getUIOperate().getSelectedItem().toString();
    String sValue = this.getUIValue().getSelectedItem().toString();
    String sValueCode = String.valueOf(this.getUIValue().getSelectedIndex());
    this.m_sReturnCode = sLogic + sName + sOperate + sValueCode;
    this.m_sReturnName = NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0082", null, new String[]{sLogic,sOperate,sValue})/*{0}物料的生命周期(){1}"{2}"*/;
    this.closeOK();
  }
  ...
  private UILabel getUIName() {
    if (this.m_lblName == null) {
      ...
      this.m_lblName.setText(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0083")/*物料的生命周期:*/);
  ...
  private UIComboBox getUIValue() {
    if (this.m_cbValue == null) {
      ...
      this.m_cbValue.addItem(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0084")/*试销期*/);
      this.m_cbValue.addItem(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0085")/*成长期*/);
      this.m_cbValue.addItem(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0086")/*成熟期*/);
      this.m_cbValue.addItem(NCLangRes.getInstance().getStrByID("4006006_0", "04006006-0087")/*衰退期*/);
