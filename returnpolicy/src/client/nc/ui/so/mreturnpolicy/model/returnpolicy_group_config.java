...
public class returnpolicy_group_config extends AbstractJavaBeanDefinition{
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getCNode_fa2738());
...
public nc.ui.uif2.tangramlayout.node.CNode getCNode_fa2738(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#fa2738")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#fa2738");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#fa2738",bean);
  bean.setComponent(getList());
return bean;
}

public List getManagedList1(){  List list = new ArrayList();  list.add(getAddAction());  list.add(getEditAction());  list.add(getDelAction());  list.add(getSeparatorAction_124fe3e());  list.add(getRefreshAction());  list.add(getSeparatorAction_1afd694());  list.add(getMaintainActionGroup());  return list;}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_124fe3e(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#124fe3e")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#124fe3e");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#124fe3e",bean);
return bean;
}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_1afd694(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#1afd694")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#1afd694");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#1afd694",bean);
return bean;
}

public List getManagedList2(){  List list = new ArrayList();  list.add(getSaveAction());  list.add(getSeparatorAction_130c5c7());  list.add(getCancelAction());  return list;}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_130c5c7(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#130c5c7")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#130c5c7");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#130c5c7",bean);
return bean;
}
