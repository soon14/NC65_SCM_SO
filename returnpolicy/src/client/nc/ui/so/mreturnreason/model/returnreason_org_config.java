...
public class returnreason_org_config extends AbstractJavaBeanDefinition{
...
public List getManagedList1(){  List list = new ArrayList();  list.add(getOrgEditHandler_13e0110());  return list;}

public nc.ui.so.mreturnreason.model.OrgEditHandler getOrgEditHandler_13e0110(){
 if(context.get("nc.ui.so.mreturnreason.model.OrgEditHandler#13e0110")!=null)
 return (nc.ui.so.mreturnreason.model.OrgEditHandler)context.get("nc.ui.so.mreturnreason.model.OrgEditHandler#13e0110");
  nc.ui.so.mreturnreason.model.OrgEditHandler bean = new nc.ui.so.mreturnreason.model.OrgEditHandler();
  context.put("nc.ui.so.mreturnreason.model.OrgEditHandler#13e0110",bean);
return bean;
}
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getVSNode_19b9a6a());
...
public nc.ui.uif2.tangramlayout.node.VSNode getVSNode_19b9a6a(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#19b9a6a")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#19b9a6a");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#19b9a6a",bean);
  bean.setDown(getCNode_1b7ec22());
  bean.setUp(getCNode_1efb230());
  bean.setDividerLocation(31f);
return bean;
}

public nc.ui.uif2.tangramlayout.node.CNode getCNode_1b7ec22(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1b7ec22")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1b7ec22");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1b7ec22",bean);
  bean.setComponent(getList());
return bean;
}

public nc.ui.uif2.tangramlayout.node.CNode getCNode_1efb230(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1efb230")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1efb230");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1efb230",bean);
  bean.setComponent(getOrgPanel());
return bean;
}

public List getManagedList2(){  List list = new ArrayList();  list.add(getAddAction());  list.add(getEditAction());  list.add(getDelAction());  list.add(getSeparatorAction_b6c2b2());  list.add(getRefreshAction());  list.add(getSeparatorAction_a83fc4());  list.add(getMaintainActionGroup());  return list;}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_b6c2b2(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#b6c2b2")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#b6c2b2");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#b6c2b2",bean);
return bean;
}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_a83fc4(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#a83fc4")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#a83fc4");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#a83fc4",bean);
return bean;
}

public List getManagedList3(){  List list = new ArrayList();  list.add(getSaveAction());  list.add(getSeparatorAction_1f279eb());  list.add(getCancelAction());  return list;}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_1f279eb(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#1f279eb")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#1f279eb");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#1f279eb",bean);
return bean;
}
