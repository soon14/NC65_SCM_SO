...
public class returnassign_group_config extends AbstractJavaBeanDefinition{
...
public List getManagedList1(){  List list = new ArrayList();  list.add(getBodyBeforeEditHandler_7478c0());  return list;}

public nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler getBodyBeforeEditHandler_7478c0(){
 if(context.get("nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler#7478c0")!=null)
 return (nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler)context.get("nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler#7478c0");
  nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler bean = new nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler();
  context.put("nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler#7478c0",bean);
return bean;
}
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getCNode_a39f20());
...
public nc.ui.uif2.tangramlayout.node.CNode getCNode_a39f20(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#a39f20")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#a39f20");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#a39f20",bean);
  bean.setComponent(getList());
return bean;
}

public List getManagedList2(){  List list = new ArrayList();  list.add(getAddAction());  list.add(getEditAction());  list.add(getDelAction());  list.add(getSeparatorAction_242dcd());  list.add(getRefreshAction());  list.add(getSeparatorAction_13b1bf6());  list.add(getMaintainActionGroup());  return list;}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_242dcd(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#242dcd")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#242dcd");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#242dcd",bean);
return bean;
}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_13b1bf6(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#13b1bf6")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#13b1bf6");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#13b1bf6",bean);
return bean;
}

public List getManagedList3(){  List list = new ArrayList();  list.add(getSaveAction());  list.add(getSeparatorAction_1a8f3b5());  list.add(getCancelAction());  return list;}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_1a8f3b5(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#1a8f3b5")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#1a8f3b5");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#1a8f3b5",bean);
return bean;
}
