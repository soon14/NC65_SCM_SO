...
public class returnassign_org_config extends AbstractJavaBeanDefinition{
...
public List getManagedList1(){  List list = new ArrayList();  list.add(getBodyBeforeEditHandler_158cfa());  return list;}

public nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler getBodyBeforeEditHandler_158cfa(){
 if(context.get("nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler#158cfa")!=null)
 return (nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler)context.get("nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler#158cfa");
  nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler bean = new nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler();
  context.put("nc.ui.so.mreturnassign.editor.BodyBeforeEditHandler#158cfa",bean);
return bean;
}
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getVSNode_f78eb8());
...
public nc.ui.uif2.tangramlayout.node.VSNode getVSNode_f78eb8(){
 if(context.get("nc.ui.uif2.tangramlayout.node.VSNode#f78eb8")!=null)
 return (nc.ui.uif2.tangramlayout.node.VSNode)context.get("nc.ui.uif2.tangramlayout.node.VSNode#f78eb8");
  nc.ui.uif2.tangramlayout.node.VSNode bean = new nc.ui.uif2.tangramlayout.node.VSNode();
  context.put("nc.ui.uif2.tangramlayout.node.VSNode#f78eb8",bean);
  bean.setDown(getCNode_dab1c1());
  bean.setUp(getCNode_1cc1310());
  bean.setDividerLocation(31f);
return bean;
}

public nc.ui.uif2.tangramlayout.node.CNode getCNode_dab1c1(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#dab1c1")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#dab1c1");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#dab1c1",bean);
  bean.setComponent(getList());
return bean;
}

public nc.ui.uif2.tangramlayout.node.CNode getCNode_1cc1310(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1cc1310")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1cc1310");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1cc1310",bean);
  bean.setComponent(getOrgPanel());
return bean;
}

public List getManagedList2(){  List list = new ArrayList();  list.add(getAddAction());  list.add(getEditAction());  list.add(getDelAction());  list.add(getSeparatorAction_baf35a());  list.add(getRefreshAction());  list.add(getSeparatorAction_1beb8dc());  list.add(getMaintainActionGroup());  return list;}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_baf35a(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#baf35a")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#baf35a");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#baf35a",bean);
return bean;
}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_1beb8dc(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#1beb8dc")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#1beb8dc");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#1beb8dc",bean);
return bean;
}

public List getManagedList3(){  List list = new ArrayList();  list.add(getSaveAction());  list.add(getSeparatorAction_5a7eab());  list.add(getCancelAction());  return list;}

public nc.funcnode.ui.action.SeparatorAction getSeparatorAction_5a7eab(){
 if(context.get("nc.funcnode.ui.action.SeparatorAction#5a7eab")!=null)
 return (nc.funcnode.ui.action.SeparatorAction)context.get("nc.funcnode.ui.action.SeparatorAction#5a7eab");
  nc.funcnode.ui.action.SeparatorAction bean = new nc.funcnode.ui.action.SeparatorAction();
  context.put("nc.funcnode.ui.action.SeparatorAction#5a7eab",bean);
return bean;
}
