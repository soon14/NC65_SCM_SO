insert into pub_print_template(ctemplateid,bdirector,bdispagenum,bdistotalpagenum,billspace,bnormalcolor,devorg,dr,extendattr,ffontstyle,fpagination,ibotmargin,ibreakposition,ifontsize,igridcolor,ileftmargin,ipageheight,ipagelocate,ipagewidth,irightmargin,iscale,itopmargin,itype,layer,mdclass,model_type,modelheight,modelwidth,pk_corp,pk_org,prepare1,prepare2,ptemplateid,ts,vdefaultprinter,vfontname,vleftnote,vmidnote,vnodecode,vrightnote,vtemplatecode,vtemplatename) values('0001Z81000000000KLRQ','Y','Y','Y',null,'N','~',0,'<nc.vo.pub.print.PrintTemplateExtVO>
  ...
  <mergeVO>
    ...
    <hgap>0.0</hgap>
    <vgap>0.0</vgap>
    <locateType>4</locateType>
  </mergeVO>
</nc.vo.pub.print.PrintTemplateExtVO>',0,0,20,0,9,-4144960,20,842,'21',595,20,100,20,1,0,'53b41cad-e90d-4dd3-9f49-8a78d4a08bdb',null,null,null,'@@@@','~','000000001000','false','~','2015-07-14 14:07:20',null,'SimSun','第','页 共','4006080108','页','4006080108','退货政策分配（销售组织）默认打印模板')
go
