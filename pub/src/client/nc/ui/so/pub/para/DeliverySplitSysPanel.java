...
import nc.vo.so.pub.enumeration.DeliverySplitRule;
 ...
 * @author 祝会征
 */
public class DeliverySplitSysPanel extends AbstractParaListToListPanel {
   ...
   */
  public DeliverySplitSysPanel(String pk_org) {
    super();
  }
  ...
  public Map<String, String> getKeyNameRela() {
    if (null == this.mapKeyName) {
      ...
      for (DeliverySplitRule rule : DeliverySplitRule.values()) {
  ...
  public String getParamValueCode() {
    return ParameterList.SO19.getCode();
  }
