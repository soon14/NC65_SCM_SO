 ...
 * @author 祝会征
 */
public class FindPriceCondtionPanel extends AbstractParaListToListPanel {
   ...
   */
  public FindPriceCondtionPanel(String pk_org) {
    super();
  }
  ...
  public Map<String, String> getKeyNameRela() {
    if (null == this.mapKeyName) {
      ...
      for (FindPriceTrigRule rule : FindPriceTrigRule.values()) {
  ...
  public String getParamValueCode() {
    return ParameterList.SO21.getCode();
  }
