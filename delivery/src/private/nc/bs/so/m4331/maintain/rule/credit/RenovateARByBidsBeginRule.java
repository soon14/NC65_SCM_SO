 ...
 * 销售发货单行动作前信用占用检查
 * @scene
 * 发货单：行关闭、行打开、（4C、33）回写发货单、修订价格操作前。
 * @param
 * billaction 销售管理动作按钮
 */
public class RenovateARByBidsBeginRule implements IRule<DeliveryViewVO> {

  private M4331EngrossAction billaction;

  public RenovateARByBidsBeginRule(M4331EngrossAction billaction) {
