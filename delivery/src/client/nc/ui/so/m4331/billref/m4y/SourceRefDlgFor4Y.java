...
public class SourceRefDlgFor4Y extends SourceRefDlg {
	/**
     * 
     */
	private static final long serialVersionUID = -4385434936229999968L;

	public SourceRefDlgFor4Y(Container parent, BillSourceVar bsVar) {
	...
	public String getRefBillInfoBeanPath() {
		return "nc/ui/so/m4331/billref/m4y/M4YRef4331Info.xml";
	}
