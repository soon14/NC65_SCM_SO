...
public class saleinvoice_unApprove_config extends AbstractJavaBeanDefinition{
...
public nc.ui.so.m32.closingcheck.IA2012Model getManageAppModel(){
 if(context.get("manageAppModel")!=null)
 return (nc.ui.so.m32.closingcheck.IA2012Model)context.get("manageAppModel");
  nc.ui.so.m32.closingcheck.IA2012Model bean = new nc.ui.so.m32.closingcheck.IA2012Model();
...
public nc.ui.so.pub.closingcheck.IABatchTable getListView(){
 ...
 return (nc.ui.so.pub.closingcheck.IABatchTable)context.get("listView");
  ...
  bean.setVoClassName("nc.vo.so.m32.entity.SaleInvoiceHVO");
...
private java.lang.String getI18nFB_7beafc(){
 if(context.get("nc.ui.uif2.I18nFB#7beafc")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#7beafc");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#7beafc",bean);  bean.setResDir("10140curtp");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#7beafc",product);
...
public nc.ui.so.m32.closingcheck.ClosePrintAction getPreViewAction(){
 if(context.get("preViewAction")!=null)
 return (nc.ui.so.m32.closingcheck.ClosePrintAction)context.get("preViewAction");
  nc.ui.so.m32.closingcheck.ClosePrintAction bean = new nc.ui.so.m32.closingcheck.ClosePrintAction();
...
public nc.ui.so.m32.closingcheck.ClosePrintAction getPrintAction(){
 if(context.get("printAction")!=null)
 return (nc.ui.so.m32.closingcheck.ClosePrintAction)context.get("printAction");
  nc.ui.so.m32.closingcheck.ClosePrintAction bean = new nc.ui.so.m32.closingcheck.ClosePrintAction();
...
private List getManagedList1(){  List list = new ArrayList();  list.add(getCNode_1806c98());  return list;}

private nc.ui.uif2.tangramlayout.node.CNode getCNode_1806c98(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#1806c98")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#1806c98");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#1806c98",bean);
