...
import nc.vo.so.m32.entity.SaleInvoiceViewMeta;
import nc.bs.framework.common.NCLocator;
import com.yonyou.uat.framework.BaseTestCase;
public class SaleInvoiceViewMetaTest extends BaseTestCase {
  SaleInvoiceViewMeta saleInvoiceViewMeta=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    saleInvoiceViewMeta=NCLocator.getInstance().lookup(SaleInvoiceViewMeta.class);
  }
