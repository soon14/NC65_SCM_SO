...
import nc.vo.pub.lang.UFDateTime;
import nc.vo.pub.IVOMeta;
public class SaleInvoiceBVOTest extends BaseTestCase {
  SaleInvoiceBVO saleInvoiceBVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    saleInvoiceBVO=NCLocator.getInstance().lookup(SaleInvoiceBVO.class);
  }
  ...
  public void getCsaleinvoiceid(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=saleInvoiceBVO.getCsaleinvoiceid();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setCsaleinvoiceid(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String csaleinvoiceid=(String)dp.get("csaleinvoiceid").get(0);
    
    //Invoke tested method
    saleInvoiceBVO.setCsaleinvoiceid(csaleinvoiceid);
  ...
  public void getMetaData(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    IVOMeta retObj=null;
    retObj=saleInvoiceBVO.getMetaData();
