...
import nc.vo.so.m32.entity.SaleInvoiceSPVO;
...
import nc.vo.pub.lang.UFDateTime;
import nc.vo.pub.IVOMeta;
public class SaleInvoiceSPVOTest extends BaseTestCase {
  SaleInvoiceSPVO saleInvoiceSPVO=null;
  DBManage dbManage=null;
  
  @BeforeClass 
  public void BeforeClass(){
    saleInvoiceSPVO=NCLocator.getInstance().lookup(SaleInvoiceSPVO.class);
  }
  ...
  public void getCsaleinvoicebid(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    
    //Invoke tested method
    String retObj="";
    retObj=saleInvoiceSPVO.getCsaleinvoicebid();
  ...
  @Test(description="",dependsOnMethods={},groups="",timeOut=100000,dataProvider="dp") 
  public void setCsaleinvoicebid(  Map<String,ArrayList<String>> dp){
    
    //Construct method parameters
    String csaleinvoicebid=(String)dp.get("csaleinvoicebid").get(0);
    
    //Invoke tested method
    saleInvoiceSPVO.setCsaleinvoicebid(csaleinvoicebid);
  ...
  public void getMetaData(  Map<String,ArrayList<String>> dp){
    ...
    //Invoke tested method
    IVOMeta retObj=null;
    retObj=saleInvoiceSPVO.getMetaData();
