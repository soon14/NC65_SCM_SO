...
public class UnSquareEstAction extends NCAction {
  ...
  public UnSquareEstAction() {
    SCMActionInitializer.initializeAction(this, SCMActionCode.SO_UNESTIMATE);
  }
  ...
  public void doAction(ActionEvent e) throws Exception {
    ...
    ShowStatusBarMsgUtil
        .showStatusBarMsg(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes()
            .getStrByID("4006010_0", "04006010-0002")/*@res "取消暂估应收成功！"*/,
