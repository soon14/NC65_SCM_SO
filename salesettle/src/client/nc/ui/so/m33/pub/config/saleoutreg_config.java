...
public class saleoutreg_config extends AbstractJavaBeanDefinition{
...
public nc.ui.so.m33.manreg.model.SaleOutRegQueryService getQryService(){
 if(context.get("qryService")!=null)
 return (nc.ui.so.m33.manreg.model.SaleOutRegQueryService)context.get("qryService");
  nc.ui.so.m33.manreg.model.SaleOutRegQueryService bean = new nc.ui.so.m33.manreg.model.SaleOutRegQueryService();
...
public nc.ui.so.m33.manreg.view.M33REGBillListView getListView(){
 if(context.get("listView")!=null)
 return (nc.ui.so.m33.manreg.view.M33REGBillListView)context.get("listView");
  nc.ui.so.m33.manreg.view.M33REGBillListView bean = new nc.ui.so.m33.manreg.view.M33REGBillListView();
...
private List getManagedList1(){  List list = new ArrayList();  list.add(getQueryParam_40f7cf());  list.add(getQueryParam_14d709c());  list.add(getQueryParam_11c2f28());  return list;}

private nc.ui.uif2.userdefitem.QueryParam getQueryParam_40f7cf(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#40f7cf")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#40f7cf");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#40f7cf",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_14d709c(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#14d709c")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#14d709c");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#14d709c",bean);
...
private nc.ui.uif2.userdefitem.QueryParam getQueryParam_11c2f28(){
 if(context.get("nc.ui.uif2.userdefitem.QueryParam#11c2f28")!=null)
 return (nc.ui.uif2.userdefitem.QueryParam)context.get("nc.ui.uif2.userdefitem.QueryParam#11c2f28");
  nc.ui.uif2.userdefitem.QueryParam bean = new nc.ui.uif2.userdefitem.QueryParam();
  context.put("nc.ui.uif2.userdefitem.QueryParam#11c2f28",bean);
...
public nc.ui.uif2.TangramContainer getContainer(){
 ...
 return (nc.ui.uif2.TangramContainer)context.get("container");
  ...
  bean.setTangramLayoutRoot(getCNode_15bf0ca());
...
private nc.ui.uif2.tangramlayout.node.CNode getCNode_15bf0ca(){
 if(context.get("nc.ui.uif2.tangramlayout.node.CNode#15bf0ca")!=null)
 return (nc.ui.uif2.tangramlayout.node.CNode)context.get("nc.ui.uif2.tangramlayout.node.CNode#15bf0ca");
  nc.ui.uif2.tangramlayout.node.CNode bean = new nc.ui.uif2.tangramlayout.node.CNode();
  context.put("nc.ui.uif2.tangramlayout.node.CNode#15bf0ca",bean);
...
private List getManagedList4(){  List list = new ArrayList();  list.add(getBodyBeforeEditEventDispatcher_11d92c9());  return list;}

private nc.ui.so.m33.pub.editor.BodyBeforeEditEventDispatcher getBodyBeforeEditEventDispatcher_11d92c9(){
 if(context.get("nc.ui.so.m33.pub.editor.BodyBeforeEditEventDispatcher#11d92c9")!=null)
 return (nc.ui.so.m33.pub.editor.BodyBeforeEditEventDispatcher)context.get("nc.ui.so.m33.pub.editor.BodyBeforeEditEventDispatcher#11d92c9");
  nc.ui.so.m33.pub.editor.BodyBeforeEditEventDispatcher bean = new nc.ui.so.m33.pub.editor.BodyBeforeEditEventDispatcher();
  context.put("nc.ui.so.m33.pub.editor.BodyBeforeEditEventDispatcher#11d92c9",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

private List getManagedList5(){  List list = new ArrayList();  list.add(getBodyAfterEditEventDispatcher_8fed92());  return list;}

private nc.ui.so.m33.pub.editor.BodyAfterEditEventDispatcher getBodyAfterEditEventDispatcher_8fed92(){
 if(context.get("nc.ui.so.m33.pub.editor.BodyAfterEditEventDispatcher#8fed92")!=null)
 return (nc.ui.so.m33.pub.editor.BodyAfterEditEventDispatcher)context.get("nc.ui.so.m33.pub.editor.BodyAfterEditEventDispatcher#8fed92");
  nc.ui.so.m33.pub.editor.BodyAfterEditEventDispatcher bean = new nc.ui.so.m33.pub.editor.BodyAfterEditEventDispatcher();
  context.put("nc.ui.so.m33.pub.editor.BodyAfterEditEventDispatcher#8fed92",bean);
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}

public nc.ui.so.m33.manreg.action.SquareREGAction getSquareAction(){
 if(context.get("squareAction")!=null)
 return (nc.ui.so.m33.manreg.action.SquareREGAction)context.get("squareAction");
  nc.ui.so.m33.manreg.action.SquareREGAction bean = new nc.ui.so.m33.manreg.action.SquareREGAction();
...
public nc.ui.so.m33.manreg.action.UnSquareREGAction getUnSquareAction(){
 if(context.get("unSquareAction")!=null)
 return (nc.ui.so.m33.manreg.action.UnSquareREGAction)context.get("unSquareAction");
  nc.ui.so.m33.manreg.action.UnSquareREGAction bean = new nc.ui.so.m33.manreg.action.UnSquareREGAction();
...
public nc.funcnode.ui.action.GroupAction getPrintActionGroup(){
 ...
 return (nc.funcnode.ui.action.GroupAction)context.get("printActionGroup");
  ...
  bean.setName(getI18nFB_13618d7());
...
private java.lang.String getI18nFB_13618d7(){
 if(context.get("nc.ui.uif2.I18nFB#13618d7")!=null)
 return (java.lang.String)context.get("nc.ui.uif2.I18nFB#13618d7");
  nc.ui.uif2.I18nFB bean = new nc.ui.uif2.I18nFB();
    context.put("&nc.ui.uif2.I18nFB#13618d7",bean);  bean.setResDir("common");
...
invokeInitializingBean(bean);
 try {
    ...
    context.put("nc.ui.uif2.I18nFB#13618d7",product);
