 ...
 */
public class SquareREGAction extends NCAction {
  ...
  public SquareREGAction() {
    SCMActionInitializer.initializeAction(this, SCMActionCode.SCM_REGISTER);
  }
  ...
  public void doAction(ActionEvent e) throws Exception {
    ...
    ShowStatusBarMsgUtil.showStatusBarMsg(
        nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("4006010_0",
            "04006010-0003")/*@res "发出商品成功！"*/, this.getModel().getContext());
  }
