...
public class SquareCtrlARBillBeforeEditHandler implements IBusinessListener {
  ...
  public void doAction(IBusinessEvent event) throws BusinessException {
    ...
    for (IDataFromF0ForM33 data : datas) {
      ...
      if (data.isFromSO() && firstBillType30 && source324C4453) {
        throw new BusinessException(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("4006010_0","04006010-0056")/*@res "来源于销售结算的应收单不能手工删除！"*/);
      }
    }
